...
00000003  E8E700            call 0xed
00000006  0000              add [bx+si],al
00000008  05F82F            add ax,0x2ff8
0000000B  0000              add [bx+si],al
0000000D  8B4508            mov ax,[di+0x8]
00000010  83C005            add ax,byte +0x5
00000013  5D                pop bp
00000014  C3                ret
00000015  55                push bp
00000016  89E5              mov bp,sp
00000018  E8D200            call 0xed
0000001B  0000              add [bx+si],al
0000001D  05E32F            add ax,0x2fe3
00000020  0000              add [bx+si],al
00000022  66B8410A2666      mov eax,0x66260a41
00000028  A3D007            mov [0x7d0],ax
...
00000033  E8B700            call 0xed
00000036  0000              add [bx+si],al
00000038  05C82F            add ax,0x2fc8
0000003B  0000              add [bx+si],al
0000003D  8D8045D0          lea ax,[bx+si-0x2fbb]
00000041  FF                db 0xff
00000042  FF5DC3            call far [di-0x3d]
00000045  55                push bp
00000046  89E5              mov bp,sp
00000048  53                push bx
00000049  E8A500            call 0xf1
0000004C  0000              add [bx+si],al
0000004E  81C3B22F          add bx,0x2fb2
00000052  0000              add [bx+si],al
00000054  6A41              push byte +0x41
00000056  E8A5FF            call 0xfffe
00000059  FF                db 0xff
0000005A  FF83C404          inc word [bp+di+0x4c4]
0000005E  89C2              mov dx,ax
00000060  8B830C00          mov ax,[bp+di+0xc]
00000064  0000              add [bx+si],al
00000066  05A10F            add ax,0xfa1
00000069  0000              add [bx+si],al
0000006B  8810              mov [bx+si],dl
0000006D  8B830C00          mov ax,[bp+di+0xc]
00000071  0000              add [bx+si],al
00000073  0FB6931000        movzx dx,[bp+di+0x10]
00000078  0000              add [bx+si],al
0000007A  8810              mov [bx+si],dl
0000007C  90                nop
0000007D  8B5DFC            mov bx,[di-0x4]
00000080  C9                leave
00000081  C3                ret
00000082  55                push bp
00000083  89E5              mov bp,sp
00000085  53                push bx
00000086  83EC10            sub sp,byte +0x10
00000089  E86100            call 0xed
0000008C  0000              add [bx+si],al
0000008E  05722F            add ax,0x2f72
00000091  0000              add [bx+si],al
00000093  8B900C00          mov dx,[bx+si+0xc]
00000097  0000              add [bx+si],al
00000099  C60241            mov byte [bp+si],0x41
0000009C  8B900C00          mov dx,[bx+si+0xc]
000000A0  0000              add [bx+si],al
000000A2  83C201            add dx,byte +0x1
000000A5  C60207            mov byte [bp+si],0x7
000000A8  C745F80000        mov word [di-0x8],0x0
000000AD  0000              add [bx+si],al
000000AF  EB31              jmp short 0xe2
000000B1  8B4DF8            mov cx,[di-0x8]
000000B4  8B5508            mov dx,[di+0x8]
000000B7  01CA              add dx,cx
000000B9  8B980C00          mov bx,[bx+si+0xc]
000000BD  0000              add [bx+si],al
000000BF  8B4DF8            mov cx,[di-0x8]
000000C2  01C9              add cx,cx
000000C4  01D9              add cx,bx
000000C6  0FB612            movzx dx,[bp+si]
000000C9  8811              mov [bx+di],dl
000000CB  8B880C00          mov cx,[bx+si+0xc]
000000CF  0000              add [bx+si],al
000000D1  8B55F8            mov dx,[di-0x8]
000000D4  01D2              add dx,dx
000000D6  83C201            add dx,byte +0x1
000000D9  01CA              add dx,cx
000000DB  C6020F            mov byte [bp+si],0xf
000000DE  8345F801          add word [di-0x8],byte +0x1
000000E2  837DF80E          cmp word [di-0x8],byte +0xe
000000E6  7EC9              jng 0xb1
000000E8  90                nop
000000E9  90                nop
000000EA  8B5DFC            mov bx,[di-0x4]
000000ED  C9                leave
000000EE  C3                ret
000000EF  8B04              mov ax,[si]
000000F1  24C3              and al,0xc3
000000F3  8B1C              mov bx,[si]
000000F5  24C3              and al,0xc3
...
00001022  FF                db 0xff
00001023  FF15              call [di]
00001025  0000              add [bx+si],al
00001027  0000              add [bx+si],al
00001029  41                inc cx
0000102A  0E                push cs
0000102B  08850242          or [di+0x4202],al
0000102F  0D0551            or ax,0x5105
00001032  C50C              lds cx,[si]
00001034  0404              add al,0x4
00001036  0000              add [bx+si],al
00001038  1C00              sbb al,0x0
0000103A  0000              add [bx+si],al
0000103C  3C00              cmp al,0x0
0000103E  0000              add [bx+si],al
00001040  D5EF              aad 0xef
00001042  FF                db 0xff
00001043  FF1B              call far [bp+di]
00001045  0000              add [bx+si],al
00001047  0000              add [bx+si],al
00001049  41                inc cx
0000104A  0E                push cs
0000104B  08850242          or [di+0x4202],al
0000104F  0D0557            or ax,0x5705
00001052  C50C              lds cx,[si]
00001054  0404              add al,0x4
00001056  0000              add [bx+si],al
00001058  1C00              sbb al,0x0
0000105A  0000              add [bx+si],al
0000105C  5C                pop sp
0000105D  0000              add [bx+si],al
0000105F  00D0              add al,dl
00001061  EF                out dx,ax
00001062  FF                db 0xff
00001063  FF15              call [di]
00001065  0000              add [bx+si],al
00001067  0000              add [bx+si],al
00001069  41                inc cx
0000106A  0E                push cs
0000106B  08850242          or [di+0x4202],al
0000106F  0D0551            or ax,0x5105
00001072  C50C              lds cx,[si]
00001074  0404              add al,0x4
00001076  0000              add [bx+si],al
00001078  2000              and [bx+si],al
0000107A  0000              add [bx+si],al
0000107C  7C00              jl 0x107e
0000107E  0000              add [bx+si],al
00001080  C5                db 0xc5
00001081  EF                out dx,ax
00001082  FF                db 0xff
00001083  FF                db 0xff
00001084  3D0000            cmp ax,0x0
00001087  0000              add [bx+si],al
00001089  41                inc cx
0000108A  0E                push cs
0000108B  08850242          or [di+0x4202],al
0000108F  0D0541            or ax,0x4105
00001092  830378            add word [bp+di],byte +0x78
00001095  C5                db 0xc5
00001096  C3                ret
00001097  0C04              or al,0x4
00001099  0400              add al,0x0
0000109B  0020              add [bx+si],ah
0000109D  0000              add [bx+si],al
0000109F  00A00000          add [bx+si+0x0],ah
000010A3  00DE              add dh,bl
000010A5  EF                out dx,ax
000010A6  FF                db 0xff
000010A7  FF6D00            jmp far [di+0x0]
000010AA  0000              add [bx+si],al
000010AC  00410E            add [bx+di+0xe],al
000010AF  08850242          or [di+0x4202],al
000010B3  0D0544            or ax,0x4405
000010B6  830302            add word [bp+di],byte +0x2
000010B9  65                gs
000010BA  C5                db 0xc5
000010BB  C3                ret
000010BC  0C04              or al,0x4
000010BE  0400              add al,0x0
000010C0  1000              adc [bx+si],al
000010C2  0000              add [bx+si],al
000010C4  C400              les ax,[bx+si]
000010C6  0000              add [bx+si],al
000010C8  27                daa
000010C9  F0                lock
000010CA  FF                db 0xff
000010CB  FF04              inc word [si]
000010CD  0000              add [bx+si],al
000010CF  0000              add [bx+si],al
000010D1  0000              add [bx+si],al
000010D3  0010              add [bx+si],dl
000010D5  0000              add [bx+si],al
000010D7  00D8              add al,bl
000010D9  0000              add [bx+si],al
000010DB  0017              add [bx],dl
000010DD  F0                lock
000010DE  FF                db 0xff
000010DF  FF04              inc word [si]
...
0000300D  800B00            or byte [bp+di],0x0
00003010  48                dec ax
00003011  656C              gs insb
00003013  6C                insb
00003014  6F                outsw
00003015  20576F            and [bx+0x6f],dl
00003018  726C              jc 0x3086
0000301A  642121            and [fs:bx+di],sp
0000301D  2100              and [bx+si],ax
